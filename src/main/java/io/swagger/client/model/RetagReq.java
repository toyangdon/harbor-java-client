...
public class RetagReq {
   ...
   * @return tag
  **/
  @ApiModelProperty(value = "new tag to be created")
   ...
   * @return srcImage
  **/
  @ApiModelProperty(value = "Source image to be retagged, e.g. 'stage/app:v1.0'")
   ...
   * @return override
  **/
  @ApiModelProperty(value = "If target tag already exists, whether to override it")
