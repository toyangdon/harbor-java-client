 ...
 */
@ApiModel(description = "The object contains basic chart information")
...
public class ChartInfoEntry {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Name of chart")
  ...
  **/
  @ApiModelProperty(required = true, value = "Total count of chart versions")
  ...
  **/
  @ApiModelProperty(value = "latest version of chart")
   ...
   * @return created
  **/
  @ApiModelProperty(required = true, value = "The created time of chart")
   ...
   * @return updated
  **/
  @ApiModelProperty(value = "The created time of chart")
   ...
   * @return icon
  **/
  @ApiModelProperty(value = "The icon path of chart")
   ...
   * @return home
  **/
  @ApiModelProperty(value = "The home website of chart")
   ...
   * @return deprecated
  **/
  @ApiModelProperty(value = "Flag to indicate if the chart is deprecated")
