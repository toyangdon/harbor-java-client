...
public class Label {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The ID of label.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of label.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of label.")
   ...
   * @return color
  **/
  @ApiModelProperty(value = "The color of label.")
   ...
   * @return scope
  **/
  @ApiModelProperty(value = "The scope of label, g for global labels and p for project labels.")
   ...
   * @return projectId
  **/
  @ApiModelProperty(value = "The project ID if the label is a project label.")
   ...
   * @return creationTime
  **/
  @ApiModelProperty(value = "The creation time of label.")
   ...
   * @return updateTime
  **/
  @ApiModelProperty(value = "The update time of label.")
   ...
   * @return deleted
  **/
  @ApiModelProperty(value = "The label is deleted or not.")
